...
namespace CubiSoft.Ftp
{
    public class StreamChannel : IDisposable
    {
        ...
        public async Task<StreamChannel> OpenPassiveDataStreamAsync(FtpDataConnectionType connectionType, FtpRequest request)
        {
            ...
            var passiveConnection = new StreamChannel();
