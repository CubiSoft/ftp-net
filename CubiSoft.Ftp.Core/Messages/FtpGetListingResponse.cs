    ...
    public class FtpGetListingResponse : FtpDuplexReponse
    {
        ...
        private void ParseMessageBody()
        {
            ...
            foreach (var listingItem in listingItems)
            {
                ...
                if (TryParseDosList(listingItem, out ftpItem) || TryParseMachineList(listingItem, out ftpItem) ||
                    TryParseUnixList(listingItem, Features, out ftpItem) || TryParseVaxList(listingItem, out ftpItem))
                {
